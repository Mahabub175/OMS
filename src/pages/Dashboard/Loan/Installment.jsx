...
import InstallmentDrawerForm from "../../../components/AllSection/Loan/InstallmentDrawerForm";
...
const Installment = () => {
  ...
  return (
    <div className="px-5">
      <TableHeader setOpen={setOpen} title={"Loan Installment"} />
      ...
      <CustomDrawer open={open} setOpen={setOpen} title="Create Installment">
        <CustomForm onSubmit={onSubmit}>
          <InstallmentDrawerForm />
